			...
			<div id="centre">
				...
				<b>Tous les champs sont obligatoires</b></div>
					<form id="inscription" name="inscription" method="post" action="<%= request.getContextPath() %>/UserServelet">				
						...
						<input type="text" name="prenom" id="prenom" maxlength="50" class="input_form" value='Saliou' />
						</div>
						<div class="div_input_form">
						<input type="text" name="nom" id="nom" maxlength="50" class="input_form" value='Gaye'  />
						</div>
						<div class="div_input_form">
						<input type="text" name="date_naiss" id="date_naiss" maxlength="50" class="input_form" value=' 19/12/1998'  />
						</div>
						<div class="div_input_form">
						<input type="text" name="cni" id="cni" maxlength="50" class="input_form" value='161919980150'  />
						</div>
						<div class="div_input_form">
						<input type="text" name="adresse" id="adresse" maxlength="50" class="input_form" value='Thiés'  />
						</div>
						<div class="div_input_form">
						<input type="text" name="email" id="email" maxlength="150" class="input_form" value='saliou.gaye@univ-thies.sn'  />
						</div>
						<div class="div_input_form">
						Votre mot de passe : entre 8 et 16 caractères<br />
